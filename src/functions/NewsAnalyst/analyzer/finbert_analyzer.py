...
Uses ProsusAI/finbert - a pre-trained model for financial sentiment analysis.
...
class FinBERTAnalyzer:
    ...
    Uses ProsusAI/finbert - a model already fine-tuned for financial
    sentiment analysis. No hardcoded keywords needed.
    
    Output: positive, negative, neutral with confidence scores
    """
    
    def __init__(self, config: NewsAnalystConfig):
        """Initialize FinBERT analyzer with pre-trained model."""
        self.config = config
    ...
    def _load_model(self) -> None:
        """Load the pre-trained FinBERT model with error handling."""
    ...
    def _preprocess(self, text: str) -> str:
        ...
        # Remove stock ticker formatting ($AAPL -> AAPL)
    ...
    def analyze(self, text: str) -> Dict[str, any]:
        """
        Analyze sentiment of English financial text.
    ...
    def analyze_batch(self, texts: List[str]) -> List[Dict[str, any]]:
        """
        Analyze sentiment of multiple English financial texts.
    ...
    def _analyze_batch_chunk(self, texts: List[str]) -> List[Dict[str, any]]:
        ...
        for idx, orig_idx in enumerate(valid_indices):
            ...
            # Map scores (0=pos, 1=neg, 2=neutral)
            scores = {
                "positive": float(scores_arr[0]),
                "negative": float(scores_arr[1]),
