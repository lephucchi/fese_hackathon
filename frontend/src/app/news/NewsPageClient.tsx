...
function isNewsItem(news: NewsItem | unknown): news is NewsItem {
    return typeof news === 'object' && news !== null && 'news_id' in news;
}
...
export default function NewsPageClient() {
    ...
    const handleCardClick = (newsItem: NewsItem | unknown) => {
        if (isNewsItem(newsItem)) {
